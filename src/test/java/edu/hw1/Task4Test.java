...
class Task4Test {
    ...
    @Test void fix_String_Standart_Example() {
    ...
    @Test void fix_String_With_Whitespaces() {
        Task4 task4 = new Task4();
    ...
    @Test void fix_String_Odd_Length() {
        Task4 task4 = new Task4();
        String string = "badce";
        String response = task4.fixString(string);
    ...
    @Test void fix_String_One_Symbol() {
        Task4 task4 = new Task4();
        String string = "b";
        String response = task4.fixString(string);
    ...
    @Test void fix_String_Empty_String() {
        Task4 task4 = new Task4();
        String string = "";
        String response = task4.fixString(string);
